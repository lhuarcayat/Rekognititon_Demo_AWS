        ...
        for i, query in enumerate(queries_sequence):
            ...
            try:
                ...
                for extraction in valid_extractions:
                    ...
                    logger.info(f'   Original extracted: "{extracted_text}"')
                    logger.info(f'   Cleaned extracted: "{cleaned_extracted}"')
                    ...
                    if cleaned_expected == cleaned_extracted:
                        match_found = True
                        match_method = "EXACT_MATCH"
                    elif cleaned_expected in cleaned_extracted:
                        match_found = True
                        match_method = "EXPECTED_IN_EXTRACTED"
                    elif cleaned_extracted in cleaned_expected:
                        match_found = True
                        match_method = "EXTRACTED_IN_EXPECTED"
                    
                    logger.info(f'   Match result: {match_found} (method: {match_method})')
